...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        # print("data_shape:",self.data_stamp.shape)
    ...
    def __getitem__(self, index):
        ...
        s_end = s_begin + self.seq_len          #index + seq_len
        r_begin = s_end - self.label_len        #index - label_len
        r_end = r_begin + self.label_len + self.pred_len # index + seq_len + pred_len 
...
class Dataset_PEMS(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='ETTh1.csv',seasonal_patterns=None,
                 target='OT', scale=True, timeenc=0, freq='h',drop_short=False):
        # size [seq_len, label_len, pred_len]
        # info
        self.seq_len = size[0]
        self.label_len = size[1]
